...
const Homepage = () => {
  ...
  return (
    <>
      <div className="page-baner" data-aos="custom-center" data-aos-duration="500">
        <Slider {...setting}>
              ...
              <div className="imglinkcontent ">
                <div className="imgobject hoverimg">
                  ...
                  <div className="hidentext ">
                    <div className="elmhiden ">
                      <div className="flation ">
                      <i aria-hidden="true" className=" flaticon-chimney"></i>                      </div>
                      <p>
                        Integer lobortisy consequat consequat imperdiet sed
                        nulla sed viverra ut lorem.
                      </p>
                            ...
                            <Slider {...reviewSlide} >
                                ...
                                <div className="vote">
                                    <div className="elm-cmt">
                                        <div className="quote ">
                                        <i aria-hidden="true" className=" flaticon-quote-1"></i>                                        </div>
                ...
                <div className="body-container">
                    ...
                    <div className="row clearfix">
                        <div className="tab col-xl-4 col-md-6 col-sm-12 ">
                            ...
                            <i aria-hidden="true" className="flaticon-power-7"></i>                                                        <div className="img-name ">
                                    SEAMLESS COSTT
                                </div>
