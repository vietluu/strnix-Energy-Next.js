                ...
                <div className="ten-container ">
                    <div className="row-list ">
                        ...
                        <div className="social-logo ">
                            <a href="# "><img src="https://smartdemowp.com/strnix/wp-content/uploads/2020/06/logo.svg " alt="Logo "/>
                            </a>
                    ...
                    <div className="row-services ">
                        <div className="contact-elm clearfix ">
                            ...
                            <div className="info ">
                                <div className="icon-img ">
                                    <img src="https://smartdemowp.com/strnix/wp-content/uploads/2020/06/icon-mail-1.png " alt="image "/>
