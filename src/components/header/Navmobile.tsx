    ...
    <nav className="mobile-menu">
      <div className="dropdownnav-menu">
        <ul id="dropdown">
          ...
          <li id="first" onClick={(e) => handleShowDropdown(e.currentTarget)}>
          ...
          <li id="sercond" onClick={(e) => handleShowDropdown(e.currentTarget)}>
          ...
          <li id="third" onClick={(e) => handleShowDropdown(e.currentTarget)}>
